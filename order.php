                ...
                <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Order Menu Makanan dan Minuman
                            </h1>
                            ...
                            <form class="needs-validation" novalidate action="proses/proses_delete_order.php"
                                ...
                                <div class="col-lg-12">
                                    apakah anda ingin menghapus Order Atas Nama<b>
                                        <?php echo $row['pelanggan']?></b> Dengan Kode Order<b>
                                        <?php echo $row['id_order']?></b>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
                ...
                <table class="table table-hover" id="example">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php echo (!empty($row['id_bayar'])) ? "<span class='badge text-bg-success'>Dibayar</span>" : "<span class='badge text-bg-danger'>Belum Bayar</span>" ; ?>
                            </td>
                            <td>
                            ...
                            <td class="d-flex">
                                ...
                                <a class="btn btn-info btn-sm me-1"
                                    href="./?x=orderitem&order=<?php echo $row['id_order']."&meja=".$row['meja']."&pelanggan=".$row['pelanggan']?>">
