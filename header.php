...
<nav class="navbar navbar-expand bg-primary sticky-top" data-bs-theme="dark">
    <div class="container-lg">
        <a class="navbar-brand" href="."><i class="bi bi-cup-hot"></i> Cafe Kita</a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-2">
                        ...
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                data-bs-target="#modalubahPassword"><i class="bi bi-key"></i> Ubah Password</a>
                        </li>
                        ...
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <input disabled type="email" class="form-control" id="floatingInput"
                                    ...
                                    value="<?php echo $_SESSION['username_cafekita'] ?>">
                        ...
                        <div class="col-lg-12">
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="" style="height: 100px;"
                                    name="alamat"><?php echo $record['alamat']?></textarea>
