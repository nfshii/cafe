                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floatingPassword">Jumlah porsi</label>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floatingPassword">Nominal Uang</label>
                                            <div class="invalid-feedback">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if($row['status'] == 1) {
                                    echo "<span class='badge text-bg-warning'>Sedang Proses</span>";
                                } elseif($row["status"] == 2) {
                                    echo "<span class='badge text-bg-success'>Siap Saji</span>";
                                }elseif($row["status"] == 0) {
                                    echo "<span class='badge text-bg-danger'>Pesanan Masuk</span>";
                                }
                                ?>
                            </td>
                            <td>
        ...
        $total +=$row['harganya'];
            ...
            <div>
                <button
                    ...
                    data-bs-toggle="modal" data-bs-target="#tambahitem"><i class=" bi bi-plus-circle"></i>Tambah
                    Item</button>
                <button
                    class="<?php echo(!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-primary" ; ?>"
                    data-bs-toggle="modal" data-bs-target="#bayar"> <i class=" bi
                    bi-cash-coin"></i>Bayar</button>
...
<div id="strukContent" class="d-none">
    ...
    <div id="struk">
        <h2>Struk Pembayaran <br>Cafe Kita</h2>
